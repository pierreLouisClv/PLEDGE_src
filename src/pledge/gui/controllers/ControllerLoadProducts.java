 ...
 */
public class ControllerLoadProducts extends AbstractAction{

    private ModelPLEDGE model;
    private ViewPLEDGE view;

    public ControllerLoadProducts(ModelPLEDGE model, ViewPLEDGE view) {
        this.model = model;
        this.view = view;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (selected != null) {
            ...
            final Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        model.loadProducts(productsPath);
                    } catch (Exception ex) {
