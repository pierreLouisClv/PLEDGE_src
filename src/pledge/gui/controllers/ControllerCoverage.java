 ...
 */
public class ControllerCoverage extends AbstractAction {

    private ModelPLEDGE model;
    private ViewPLEDGE viewPLEDGE;

    public ControllerCoverage(ModelPLEDGE model, ViewPLEDGE viewPLEDGE) {
        this.model = model;
    ...
    public void actionPerformed(ActionEvent e) {
        final Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                   viewPLEDGE.displayCoverage(model.getPairwiseCoverage());
                } catch (Exception ex) {
