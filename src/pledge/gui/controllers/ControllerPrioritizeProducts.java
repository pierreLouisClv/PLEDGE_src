 ...
 */
public class ControllerPrioritizeProducts extends AbstractAction{
    private ModelPLEDGE model;
    private ViewPLEDGE viewPLEDGE;

    public ControllerPrioritizeProducts(ModelPLEDGE model, ViewPLEDGE viewPLEDGE) {
        this.model = model;
